...
const baseTools: ToolDefinition[] = [
  ...
  },
  {
    ...
    inputSchema: getTableTrashInput.shape,
  },
  {
    ...
    inputSchema: restoreTableFromTrashInput.shape,
  },
  {
    name: "permanently_delete_table",
    description: "Permanently and irreversibly delete a table. This cannot be undone. The table must already be in the trash.",
    inputSchema: permanentlyDeleteTableInput.shape,
  },
  {
    name: "export_table_data",
    description: "Export all data from a table.",
    inputSchema: exportTableDataInput.shape,
  },
  {
    name: "share_view",
    description: "Enable or disable public share link for a view. Returns the share URL when enabled.",
    inputSchema: shareViewInput.shape,
  },
  {
    ...
    inputSchema: getFieldDependencyGraphInput.shape,
  },
  {
    ...
    inputSchema: analyzeFieldImpactInput.shape,
  },
];
